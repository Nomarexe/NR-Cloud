...
class FileUploader {
    ...
    createUploadInterface() {
        ...
        uploadContainer.innerHTML = `
            <div class="upload-area" id="upload-area-${this.category}">
                ...
                <p class="upload-text">Trascina i file ${this.category} qui o <span class="upload-link">clicca per selezionare</span></p>
    ...
    bindEvents() {
        ...
        uploadArea.addEventListener('click', (e) => {
            if (e.target.closest('.upload-link') || !e.target.closest('input')) {
                fileInput.click();
            }
        });
                ...
                if (result.success) {
                    ...
                    resultsContainer.innerHTML += `
                        <div class="upload-result error">
                            <span class="icon">✗</span>
                            <span>Errore con ${file.name}: ${result.error || 'Errore sconosciuto'}</span>
                        </div>
                    `;
                }
            } catch (error) {
